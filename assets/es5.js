...
Object.create = function(proto, opt_properties) {
  ...
  for (var k in proto) {
    tNewPrototype[k] = proto[k];
  }

  return tNewPrototype;
};
 ...
 */
Object.getPrototypeOf = function(obj) {return {}};
 ...
 */
Object.prototype.toJSON = function(opt_key) {return ''};
 ...
 * @override
 */
Date.prototype.toJSON = function(opt_ignoredKey) {return ''};
